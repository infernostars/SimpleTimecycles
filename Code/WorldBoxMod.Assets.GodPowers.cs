...
namespace PowerBox
{
    partial class WorldBoxMod
    {
        private static void initGodPowersAssets()
        {
            ...
            addTraitsDrop.texture = "drops/drop_fireworks";
            ...
            addItemsDrop.texture = "drops/drop_fireworks";
            ...
            friendshipNotRandomDrop.texture = "drops/drop_friendship";
            ...
            spiteNotRandomDrop.texture = "drops/drop_spite";
            ...
            upgradebuildingAddDrop.texture = "drops/drop_snow";
            ...
            downgradeBuildingAddDrop.texture = "drops/drop_snow";
            ...
            makeColonyDrop.texture = "drops/drop_gold";
            ...
            randomKingdomColorDrop.texture = "drops/drop_gold";
            ...
            cloudBloodRainD.texture = "drops/drop_blood";
            ...
            cloudBloodRain.texture = "drops/drop_blood";
            ...
            cloudBurgerSpiderD.texture = "drops/drop_blood";
            ...
            cloudBurgerSpider.texture = "drops/drop_blood";
            ...
            spawnTradingBoatDrop.texture = "drops/drop_metal";
            ...
            spawnTransportBoatDrop.texture = "drops/drop_metal";
            ...
            spawnFishingBoatDrop.texture = "drops/drop_metal";
        ...
        public static void action_addTraits(WorldTile pTile = null, string pDropID = null)
        {
            ...
            foreach (Actor tempMapObject in temp_map_objects)
            {
                ...
                {
                    if(TType == PowerType.add && SelectedToAdd.Count != 0)
                    {
                        for (int i = 0; i < SelectedToAdd.Count; i++)
                        {
                            tempMapObject.addTrait(SelectedToAdd[i]);
                        }
                    }
                    else if(TType == PowerType.remove && SelectedToRemove.Count != 0)
                    {
                        for (int i = 0; i < SelectedToRemove.Count; i++)
                        {
                            tempMapObject.removeTrait(SelectedToRemove[i]);
                        }
                    }
        ...
        public static void action_addItems(WorldTile pTile = null, string pDropID = null)
        {
            ...
            foreach (Actor tempMapObject in temp_map_objects)
            {
                if (tempMapObject.base_data.alive && tempMapObject.stats.use_items)
                {
                    ...
                    {
                        foreach(var pr in choosenForAddSlots)
                        {
                            var slot = pr.Value;
                            ...
                            var unitSlot = tempMapObject.equipment.getSlot(slot.data.type);

                            if (unitSlot.data != null)
                            {
                                if (!(slot.data.id == unitSlot.data.id && slot.data.material == unitSlot.data.material && slot.data.suffix == unitSlot.data.suffix))
                                {
                    ...
                    {
                        var chs = choosenForRemoveSlots.Values.ToList();
                        foreach (var pr in choosenForRemoveSlots)
                        {
                            var slot = pr.Value;
