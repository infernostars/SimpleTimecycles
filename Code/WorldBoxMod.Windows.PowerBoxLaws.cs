...
namespace PowerBox
{
    partial class WorldBoxMod
    {
        ...
        private static void initPowerBoxLawsWindow()
        {
        ...
        #region disasters
        private static void initDisasters()
        {
        ...
        private static void initPowerBoxLaws(ScrollWindow window)
        {
            ...
            var upgradeBuildingsLaw = Helper.GodPowerTab.createWorldLaw(
                "upgradeBuildingsLaw",
                Mod.EmbededResources.LoadSprite(resources + ".laws.upgrade_buildings.png", 0, 0),
                tabCivs.transform,
            ...
            var shootingTroughMountainsLaw = Helper.GodPowerTab.createWorldLaw(
                ...
                Mod.EmbededResources.LoadSprite(resources + ".laws.shoot_through_mountains.png", 0, 0),
                tabCivs.transform,
                ToggleLaw,
            ...
            var civsReproducitonLaw = Helper.GodPowerTab.createWorldLaw(
                "civsReproductionLaw",
                Mod.EmbededResources.LoadSprite(resources + ".laws.civs_reproduction.png", 0, 0),
                tabCivs.transform,
                ToggleLaw,
            ...
            var spawnMadCreaturesLaw = Helper.GodPowerTab.createWorldLaw(
                ...
                Mod.EmbededResources.LoadSprite(resources + ".laws.mad_animals.png", 0, 0),
                tabNature.transform,
            ...
            var moreDisastersLaw = Helper.GodPowerTab.createWorldLaw(
                "moreDisastersLaw",
                Mod.EmbededResources.LoadSprite(resources + ".laws.disasters.png", 0, 0),
                tabNature.transform,
                ToggleLaw,
                "More Disasters",
            ...
            //     "spawnInsectsLaw",
            //     Mod.EmbededResources.LoadSprite(resources + ".laws.insects_spawn.png", 0, 0),
            //     tabNature.transform,
            //     ToggleLaw,
            //     "Insect Spawn",
            ...
            var animalsReproducitonLaw = Helper.GodPowerTab.createWorldLaw(
                ...
                Mod.EmbededResources.LoadSprite(resources + ".laws.animals_reproduction.png", 0, 0),
                tabNature.transform,
                ToggleLaw,
                "Animal Reproduction",
        ...
        private static string getLawId(WorldLawElement worldLawEl)
        {
        ...
        private static void spawnMadCreaturesLawClick(WorldLawElement worldLawEl)
        {
        ...
        static string[] buildingUpgradeToggle = { "tent_", "house_", "1house_", "2house_", "3house_", "4house_", "hall_", "1hall_"};
        static string[] racePostfix = { "human", "elf", "dwarf", "orc" };

        private static void upgradeBuildingsLawClick(WorldLawElement worldLawEl)
        {
            var lawID = getLawId(worldLawEl);
        ...
        public static void spawnCloudAction(DisasterAsset pAsset, string dropID) 
        {
            ...
            switch (dropID)
            {
                case "cloudBurgerSpider":
                    ...
                    Helper.HisHud.newText("Oh no! Burger-spider rain!?.", Toolbox.color_log_warning, Mod.EmbededResources.LoadSprite(resources + ".units.burgerSpider.icon.png", 0, 0));
                    break;
                case "cloudBloodRain":
        ...
        private static void spawnInsectsLawClick(WorldLawElement worldLawEl)
        {
            var lawID = getLawId(worldLawEl);
        ...
        private static void regenerationLawClick(WorldLawElement worldLawEl)
        {
            var lawID = getLawId(worldLawEl);
