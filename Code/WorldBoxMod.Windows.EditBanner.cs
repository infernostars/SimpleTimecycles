...
namespace PowerBox
{
    ...
    {
        private static void initEditBannerWindow(Transform inspect_kingdomBackground)
        {
            ...
            var editBanner = Helper.GodPowerTab.createButton(
                "EditBanner",
                Mod.EmbededResources.LoadSprite(resources + ".powers.flags.png", 0, 0),
            ...
            editBanner.GetComponent<Image>().sprite = Mod.EmbededResources.LoadSprite(resources + ".other.backgroundBackButtonRev.png", 0, 0);
            ...
            changeBannerBtn = Helper.GodPowerTab.createButton(
                "changeBannerBtn",
                Mod.EmbededResources.LoadSprite(resources + ".powers.banner_flags.png", 0, 0),
                bg,
                () => { 
                    Change_Banner_Edit();
        ...
        public static void Change_Banner_Edit()
        {
            if (bannerChooseBg)
            {
                bannerChooseBg = false;

                changeBannerBtn.transform.Find("Icon").GetComponent<Image>().sprite = Mod.EmbededResources.LoadSprite(resources + ".powers.background_flags.png", 0, 0);
            ...
            {
                bannerChooseBg = true;
                changeBannerBtn.transform.Find("Icon").GetComponent<Image>().sprite = Mod.EmbededResources.LoadSprite(resources + ".powers.banner_flags.png", 0, 0);
                NCMS.Utils.Localization.setLocalization("changeBannerBtn", "Icons");
                //Helper.Localization.setLocalization("changeBannerBtn", "Icons");
            }
        }

        public static void Edit_Banner_Button_Click()
        {
        ...
        static Dictionary<string, customBanner> customBanners = new Dictionary<string, customBanner>();
        class customBanner
        {
        ...
        private static void initEditBanner(ScrollWindow window)
        {
        ...
        private static void loadBanner(int index, Transform parent, List<Sprite> backgrounds, List<Sprite> icons, ScrollWindow window)
        {
