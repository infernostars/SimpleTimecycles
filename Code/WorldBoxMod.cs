...
namespace PowerBox
{
    ...
    public partial class WorldBoxMod : MonoBehaviour
    {
        ...
        private void Patching(Harmony harmony)
        {
            ...
            Helper.Utils.HarmonyPatching(harmony, "postfix", AccessTools.Method(typeof(MapBox), "spawnNewUnit"), AccessTools.Method(typeof(WorldBoxMod), "createNewUnitBySpawning_Postfix"));
            Debug.Log("Postfix: MapBox.spawnNewUnit");

            Helper.Utils.HarmonyPatching(harmony, "postfix", AccessTools.Method(typeof(MapBox), "createNewUnit"), AccessTools.Method(typeof(WorldBoxMod), "createNewUnit_Postfix"));
            Debug.Log("Postfix: MapBox.createNewUnit");

            Helper.Utils.HarmonyPatching(harmony, "postfix", AccessTools.Method(typeof(DisasterLibrary), "getRandomAssetFromPool"), AccessTools.Method(typeof(WorldBoxMod), "getRandomAssetFromPool_Postfix"));
            ...
            Helper.Utils.HarmonyPatching(harmony, "prefix", AccessTools.Method(typeof(UnitSpawner), "spawnUnit"), AccessTools.Method(typeof(WorldBoxMod), "spawnUnit_Prefix"));
            Debug.Log("Prefix: UnitSpawner.spawnUnit");

            Helper.Utils.HarmonyPatching(harmony, "postfix", AccessTools.Method(typeof(BaseSimObject), "canAttackTarget"), AccessTools.Method(typeof(WorldBoxMod), "canAttackTarget_Postfix"));
            ...
            Helper.Utils.HarmonyPatching(harmony, "prefix", AccessTools.Method(typeof(ai.behaviours.CityBehProduceUnit), "tryToProduceUnit"), AccessTools.Method(typeof(WorldBoxMod), "tryToProduceUnit_Prefix"));
            Debug.Log("Prefix: ai.behaviours.CityBehProduceUnit.tryToProduceUnit_Prefix");

            Helper.Utils.HarmonyPatching(harmony, "prefix", AccessTools.Method(typeof(ai.behaviours.BehTryBabymaking), "tryStartBabymaking"), AccessTools.Method(typeof(WorldBoxMod), "tryStartBabymaking_Prefix"));
            Debug.Log("Prefix: ai.behaviours.BehTryBabymaking.tryStartBabymaking");

            Helper.Utils.HarmonyPatching(harmony, "postfix", AccessTools.Method(typeof(Actor), "killHimself"), AccessTools.Method(typeof(WorldBoxMod), "killHimself_Postfix"));
            Debug.Log("Postfix: Actor.killHimself");

            
        }

        private static Actor UNIT;
        private static ActorStatus data;
        ...
        {
            if (customBanners.ContainsKey(pKingdom.id))
            {
                __instance.partBackround.sprite = customBanners[pKingdom.id].CurrentBG.sprite;
                __instance.partIcon.sprite = customBanners[pKingdom.id].CurrentIcon.sprite;
            }
        }
        ...
        {
            customBanners = new Dictionary<string, customBanner>();
        }
